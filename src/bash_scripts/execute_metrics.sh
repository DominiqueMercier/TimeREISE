...
# ./execute_metrics.sh local -1 &> ../../logs/execute_metrics_output.txt &
    ...
    then
        ...
        then
            ...
            python -u classification.py --verbose \
                    ...
                    --process_attributions --plot_attributions \
                    --attr_name "default" --save_memory \
                    --process_aucs --compute_aucs --plot_aucs \
                    --process_infidelity --compute_infidelity \
                    --plot_infidelity \
                    --process_sensitivity --compute_sensitivity \
                    --plot_sensitivity \
                    --process_continuity --compute_continuity \
                    --plot_continuity
        fi
    fi
    SETUP=$(( SETUP+=1 ))
